"""Tier-2 TPR test cho OSNet x0.25 Phuong an 1 (kd_weight=0.2 + warmup 25
...
BASELINE_CKPT = Path(__file__).resolve().parent / "osnet_x0_25_kd_pa1_msmt17_best.pt"
ENROLLMENT = {
...
def main():
    print("Nap OSNet x0.25 Phuong an 1 (kd_weight=0.2 + warmup)...")
    ...
    print("\nDanh gia OSNet x0.25 Phuong an 1 (ca 2 camera x 6 bien the)...")
    rows = evaluate_model("osnet_x0_25_kd_pa1", embed, detector, gallery)

    df = pd.DataFrame(rows)
    out_csv = RESULTS_DIR / "p1_tang2_pa1.csv"
