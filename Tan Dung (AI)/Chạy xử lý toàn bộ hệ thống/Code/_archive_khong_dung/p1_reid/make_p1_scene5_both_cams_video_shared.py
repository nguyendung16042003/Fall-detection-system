"""
Ban tuong duong make_p1_scene5_both_cams_video.py nhung cho Backbone dung
chung (doi thu tu-so-sanh) -- de so sanh cong bang tren CUNG data (ca 2
camera Scene 5, khong chi CAM 2 nhu truoc).
"""
import sys
...
def main():
    ...
    print("Nap backbone dung chung + detector...")
    ...
    out_path = OUT_DIR / "Shared_backbone_video_Scene5_CAM1_CAM2_ghep.mp4"
