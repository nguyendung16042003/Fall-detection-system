"""
Identity Association -- Calib homography tu video quay 4 canh, moi canh 1
nguoi dung yen tai 1 trong 4 diem A/B/C/D cua hinh vuong 0.7m tren san.
Moi file video da duoc cat rieng tung canh san (Scene N).
...
*** SUA 2 DUONG DAN DUOI DAY CHO DUNG PHONG THAT TRUOC KHI CHAY ***
"""
import json
import sys
...
# *** SUA 2 DONG DUOI DAY: CALIB_DIR = noi chua video "Scene {1-4}-{CAM 1/CAM 2}.mp4"
# da quay o phong that; OUT_DIR = noi muon luu file JSON ket qua. ***
CALIB_DIR = HERE / "calib_videos_own_room"       # TODO: doi thanh duong dan video calib that
