"""
Ban DAY DU NHAT cho Test Tang 2: ca CAM 1 VA CAM 2 cua Scene 5, moi camera
x 6 bien the (goc + 5 augment: sang/toi/nhieu/nen/lat) = 12 lan chay, moi
lan ~2 track (nguoi quay lai) -- tong ~24 case, cho CA OSNet x0.5 lan
Backbone dung chung. Day la so lieu THAY THE cho cac ban truoc do (chi
CAM2, hoac chi 2 camera goc chua augment).
"""
import sys
...
def main():
    ...
    print("\nDanh gia OSNet x0.5 (ca 2 camera x 6 bien the)...")
    rows_osnet = evaluate_model("osnet_x0_5", osnet_embed, detector_osnet, gallery_osnet)
    ...
    out_csv = RESULTS_DIR / "p1_tang2_full_comparison.csv"
